...
// o11y/load scaffolding (ADR-0010 folder set). `allowUiUpdates` lets users tweak a board
// live, but the change is ephemeral (no PVC) — surviving an edit means exporting it back to
// a TS definition in the repo (ADR-0010).
